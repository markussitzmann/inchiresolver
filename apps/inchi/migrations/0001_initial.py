# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2016-08-14 20:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='inchi.Organization')),
            ],
        ),
        migrations.CreateModel(
            name='Publisher',
            fields=[
                ...
                ('added', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='inchi.Organization')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='inchi.Publisher')),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name='publisher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inchi.Publisher'),
        ),
        migrations.AlterUniqueTogether(
            name='publisher',
